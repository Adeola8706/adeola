...
jul <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202107-divvy-tripdata.csv")
aug <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202108-divvy-tripdata.csv")
sep <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202109-divvy-tripdata.csv")
oct <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202110-divvy-tripdata.csv")
nov <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202111-divvy-tripdata.csv")
dec <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202112-divvy-tripdata.csv")
jan <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202201-divvy-tripdata.csv")
feb <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202202-divvy-tripdata.csv")
mar <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202203-divvy-tripdata.csv")
apr <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202204-divvy-tripdata.csv")
may <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202205-divvy-tripdata.csv")
jun <- read_csv("C:/Users/Adeola A/Downloads/Cyclistic Raw data/202206-divvy-tripdata.csv")

#merging the indiviual datasets into one using rbind for easy view and analysis

all_trips <- rbind(jul, aug, sep, oct, nov, dec, jan, feb, mar, apr, may, jun)
